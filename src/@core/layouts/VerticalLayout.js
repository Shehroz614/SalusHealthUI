...
import { handleMenuCollapsed } from "@store/features/menuCollapsed/menuCollapsedSlice";
...
import ZoomComponent from "../../views/pages/general/sessions/subpages/session/ZoomComponent";
import { removeSession } from "../../redux/features/session/session";
...
const VerticalLayout = (props) => {
  ...
  const menuCollapsed = useSelector(
    (state) => state.menuCollapsed.menuCollapsed
  );
